...
namespace Tracnghiem_DataAccess
{
    public class ThiSinhDA
    {
       ...
       //public ThiSinhDA() : base() { }
        ...
        {
            //String strcon = "Server=.;Database=Database;Integrated Security=SSPI";
            string strcon = ConfigurationManager.ConnectionStrings["connectionstring"].ConnectionString;
            SqlConnection con = new SqlConnection(strcon);
            con.Open();
            return con;
        }
        public int dangki(string ma, string hoten, string diachi, string ngaysinh, string tendn, string mk,string truong, string lop)
        {
            try
            {
                int x = 0;
                SqlConnection con =getcon();
                string sql = "insert  Table_ThiSinh values('" + ma + "',N'" + hoten + "',N'" + diachi + "','" + ngaysinh + "','" + tendn + "','" + mk + "','"+truong+"','"+lop+"')";
        ...
        public DataSet GetKetQua()
        {
            DataSet ds = new DataSet();
            SqlConnection con = getcon();
            damt = new SqlDataAdapter("select K.MaThiSinh,T.HoTen,T.DiaChi,T.NgaySinh,T.Truong,T.Lop,K.Diem,M.TenMon from Table_ThiSinh T join Table_KetQua K on T.MaThiSinh=K.MaThiSinh join Table_MonThi M on K.MaMon=M.MaMon", con);
            damt.Fill(ds, "Table_ThiSinh");
            return ds;
        }
        ...
        public DataSet GetKetQuaCSDL(string mamon)
        {
            DataSet ds = new DataSet();
            SqlConnection con = getcon();
            damt = new SqlDataAdapter("select K.MaThiSinh,T.HoTen,T.DiaChi,T.NgaySinh,T.Truong,T.Lop,K.Diem,M.TenMon from Table_ThiSinh T join Table_KetQua K on T.MaThiSinh=K.MaThiSinh join Table_MonThi M on K.MaMon=M.MaMon where M.MaMon='"+mamon+"' ", con);
            damt.Fill(ds, "Table_ThiSinh");
            return ds;
        }
        ...
        public DataSet GetKetQuaDiemCN(string ma)
        {
            DataSet ds = new DataSet();
            SqlConnection con = getcon();
            damt = new SqlDataAdapter("select   K.MaThiSinh,T.HoTen,T.DiaChi,T.NgaySinh,T.Truong,T.Lop,K.Diem,M.TenMon from Table_ThiSinh T join Table_KetQua K on T.MaThiSinh=K.MaThiSinh join Table_MonThi M on K.MaMon=M.MaMon where M.MaMon='" + ma + "' and K.Diem=(select Max(Diem) 'Diem' from Table_KetQua where MaMon='" + ma + "')", con);
            damt.Fill(ds, "Table_ThiSinh");
            return ds;
        }
        public DataSet GetKetQuaDiemTN(string ma)
        {
            DataSet ds = new DataSet();
            SqlConnection con = getcon();
            damt = new SqlDataAdapter("select   K.MaThiSinh,T.HoTen,T.DiaChi,T.NgaySinh,T.Truong,T.Lop,K.Diem,M.TenMon from Table_ThiSinh T join Table_KetQua K on T.MaThiSinh=K.MaThiSinh join Table_MonThi M on K.MaMon=M.MaMon where M.MaMon='" + ma + "' and K.Diem=(select Min(Diem) 'Diem' from Table_KetQua where MaMon='" + ma + "')", con);
            damt.Fill(ds, "Table_ThiSinh");
            return ds;
        }
        ...
        public int UpdateCauHoi(string noidung,string mach,string macauhoi,string noidung1,string ma1,string noidung2,string ma2,string noidung3,string ma3,string noidung4,string ma4)
        {
            try
            {
                int x = 0;
                SqlConnection con = getcon();
                string sql = "Update Table_CauHoi set NoiDungCauHoi= N'" + noidung + "' where MaNguoiDung='" + mach + "' and MaCauHoi='" + macauhoi + "' Update Table_DapAn set NoiDungCauTraLoi='" + noidung1 + "' where MaCauTraLoi='" + ma1 + "' and MaCauHoi='" + macauhoi + "' Update Table_DapAn set NoiDungCauTraLoi='" + noidung2 + "' where MaCauTraLoi='" + ma2 + "' and MaCauHoi='" + macauhoi + "'  Update Table_DapAn set NoiDungCauTraLoi='" + noidung3 + "' where MaCauTraLoi='" + ma3 + "' and MaCauHoi='" + macauhoi + "'  Update Table_DapAn set NoiDungCauTraLoi='" + noidung4 + "' where MaCauTraLoi='" + ma4 + "' and MaCauHoi='" + macauhoi + "'  ";
                SqlCommand cmd = new SqlCommand(sql, con);
                x = cmd.ExecuteNonQuery();
                con.Close();
                return x;
        ...
        public int ThemCauHoi(string mach, string noidungch, string mand, string mamon, string matl1, string ndtr1, string kieu1, string matl2, string ndtr2, string kieu2, string matl3, string ndtr3, string kieu3, string matl4, string ndtr4, string kieu4)
        {
            try
            {
                int x = 0;
                SqlConnection con = getcon();
                string sql = "insert Table_CauHoi values('"+mach+"',N'"+noidungch+"','1','"+mand+"','"+mamon+"','cau hoi') insert Table_DapAn values('"+matl1+"','"+ndtr1+"','"+mach+"','"+kieu1+"')  insert Table_DapAn values('"+matl2+"','"+ndtr2+"','"+mach+"','"+kieu2+"') insert Table_DapAn values('"+matl3+"','"+ndtr3+"','"+mach+"','"+kieu3+"') insert Table_DapAn values('"+matl4+"','"+ndtr4+"','"+mach+"','"+kieu4+"')";
                SqlCommand cmd = new SqlCommand(sql, con);
                x = cmd.ExecuteNonQuery();
                con.Close();
                return x;
